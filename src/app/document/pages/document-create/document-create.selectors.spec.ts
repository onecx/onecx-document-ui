...
describe('DocumentCreateSelectors', () => {
  ...
  describe('selectCreateMimeTypes', () => {
    it('should map String[] to SelectItem[] with label=name and value=name', () => {
      ...
      expect(result).toEqual([{ label: 'application/pdf', value: 'application/pdf' }])
    })
  ...
  describe('selectDocumentCreateSubmissionSource', () => {
    it('should combine details, attachments and characteristics into submission source', () => {
      ...
      const result = selectDocumentCreateSubmissionSource.projector(details, attachments, characteristics)
