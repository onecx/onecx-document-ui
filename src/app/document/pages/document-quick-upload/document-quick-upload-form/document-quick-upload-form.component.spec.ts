...
describe('DocumentQuickUploadFormComponent', () => {
  ...
  it('should initialize form with required validators on ngOnInit', () => {
    ...
    expect(component.documentQuickUploadForm.get('documentName')!.hasValidator).toBeTruthy()
  })

  it('should set a non-null default lifeCycleState on ngOnInit', () => {
    const lifeCycleState = component.documentQuickUploadForm.get('lifeCycleState')!.value
  ...
  it('should trim spaces from control value on blur event', () => {
    ...
    expect(component.documentQuickUploadForm.get('controlName')!.value).toBe('hello')
  })
  ...
  it('should add file to attachmentArray with valid MIME type', () => {
    component.supportedMimeType = [{ label: 'application/pdf', value: 'mime-1' }]
  ...
  it('should call trimSpaces with correct args when trimSpaceOnPaste is called', () => {
    ...
    expect(component.documentQuickUploadForm.controls['documentName'].value).toBe('pasted text')
  })
