...
import { documentQuickUploadReducer, initialState } from './document-quick-upload.reducers'
...
describe('DocumentQuickUploadReducer', () => {
  describe('ensureReferenceDataLoaded', () => {
    ...
    it('should set optionsLoading=false when both types and mimeTypes are already loaded', () => {
      ...
      const state = documentQuickUploadReducer(preState, DocumentCreateOperationsActions.ensureReferenceDataLoaded())
